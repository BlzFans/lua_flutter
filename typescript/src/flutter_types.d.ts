...
type ChatSendCallback = (message: ChatPartialText) => void
...
type StickDragCallback = (details: StickDragDetails) => void

type StringValueChanged = (value: string) => void

type TextValidateFunction = (oldValue: string, newValue: string) => boolean

type TreeNodeBuilder = (context:BuildContext, entry:TreeEntry) => Widget
