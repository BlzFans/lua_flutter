...
class LuaFlutter {
  Future<String?> getPlatformVersion() {
    return LuaFlutterPlatform.instance.getPlatformVersion();
  }
}
...
@ffi.Native<ffi.Void Function(VoidPtr, Utf8Ptr)>(symbol: 'dofile')
external void _dofile(VoidPtr L, Utf8Ptr name);

void dofile(VoidPtr L, String string) {
  final strUtf8 = string.toNativeUtf8();
  _dofile(L, strUtf8);
  malloc.free(strUtf8);
}
...
@ffi.Native<ffi.Void Function(VoidPtr, Utf8Ptr, Utf8Ptr, ffi.Int64)>(symbol: 'luaRegisterClass')
external void _luaRegisterClass(VoidPtr L, Utf8Ptr className, Utf8Ptr superClass, int getProp);

void luaRegisterClass(VoidPtr L, String className, String superClass, int getProp) {
  final classNameUtf8 = className.toNativeUtf8();
  final superClassUtf8 = superClass.toNativeUtf8();
  _luaRegisterClass(L, classNameUtf8, superClassUtf8, getProp);
...
void initLuaFlutter() {
  ...
  //StateSetter
  luaRegisterClass(g_L, '(() => void) => void', '', 0);
