...
int _InkWell_InkWell(VoidPtr L) {
  try {
    ...
    var result_ = InkWell(key: key, child: child, onTap: onTap, onDoubleTap: onDoubleTap, onLongPress: onLongPress);
...
void _autoBind(VoidPtr L) {
  ...
  luaRegisterClass(L, 'Object', '', 0);

  luaRegisterClass(L, 'PointerEnterEvent', '', 0);

  luaRegisterClass(L, 'PointerExitEvent', '', 0);

  luaRegisterClass(L, 'Widget', '', 0);

  luaRegisterClass(L, 'Text', '', 0);
  ...
  luaRegisterClass(L, 'WidgetSpan', '', 0);
  ...
  luaRegisterClass(L, 'TextStyle', '', 0);
  ...
  luaRegisterClass(L, 'TextField', '', 0);
  ...
  address = ffi.Pointer.fromFunction<lua_CFunction>(_TextInputType_getProp_, exceptionalReturn).address;
  luaRegisterClass(L, 'TextInputType', '', address);
  ...
  address = ffi.Pointer.fromFunction<lua_CFunction>(_TextEditingController_getProp_, exceptionalReturn).address;
  luaRegisterClass(L, 'TextEditingController', '', address);
  ...
  address = ffi.Pointer.fromFunction<lua_CFunction>(_TextAlignVertical_getProp_, exceptionalReturn).address;
  luaRegisterClass(L, 'TextAlignVertical', '', address);
  ...
  luaRegisterClass(L, 'IconButton', 'Widget', 0);
  ...
  luaRegisterClass(L, 'TextButton', '', 0);
  ...
  luaRegisterClass(L, 'ElevatedButton', '', 0);
  ...
  luaRegisterClass(L, 'OutlinedButton', '', 0);
  ...
  address = ffi.Pointer.fromFunction<lua_CFunction>(_IconData_getProp_, exceptionalReturn).address;
  luaRegisterClass(L, 'IconData', '', address);
  ...
  address = ffi.Pointer.fromFunction<lua_CFunction>(_Color_getProp_, exceptionalReturn).address;
  luaRegisterClass(L, 'Color', '', address);
  ...
  address = ffi.Pointer.fromFunction<lua_CFunction>(_MaterialColor_getProp_, exceptionalReturn).address;
  luaRegisterClass(L, 'MaterialColor', 'Color', address);

  address = ffi.Pointer.fromFunction<lua_CFunction>(_MaterialAccentColor_getProp_, exceptionalReturn).address;
  luaRegisterClass(L, 'MaterialAccentColor', 'Color', address);

  address = ffi.Pointer.fromFunction<lua_CFunction>(_Colors_getProp_, exceptionalReturn).address;
  luaRegisterClass(L, 'Colors', '', address);

  address = ffi.Pointer.fromFunction<lua_CFunction>(_WidgetsBinding_getProp_, exceptionalReturn).address;
  luaRegisterClass(L, 'WidgetsBinding', '', address);
  ...
  luaRegisterClass(L, 'WidgetsFlutterBinding', 'WidgetsBinding', 0);
  ...
  luaRegisterClass(L, 'MaterialApp', '', 0);
  ...
  address = ffi.Pointer.fromFunction<lua_CFunction>(_ThemeData_getProp_, exceptionalReturn).address;
  luaRegisterClass(L, 'ThemeData', '', address);
  ...
  address = ffi.Pointer.fromFunction<lua_CFunction>(_ColorScheme_getProp_, exceptionalReturn).address;
  luaRegisterClass(L, 'ColorScheme', '', address);
  ...
  address = ffi.Pointer.fromFunction<lua_CFunction>(_TextTheme_getProp_, exceptionalReturn).address;
  luaRegisterClass(L, 'TextTheme', '', address);

  address = ffi.Pointer.fromFunction<lua_CFunction>(_NavigationService_getProp_, exceptionalReturn).address;
  luaRegisterClass(L, 'NavigationService', '', address);
  ...
  luaRegisterClass(L, 'Navigator', '', 0);
  ...
  luaRegisterClass(L, 'NavigatorState', '', 0);
  ...
  luaRegisterClass(L, 'Route', '', 0);

  luaRegisterClass(L, 'DialogRoute', 'Route', 0);
  ...
  luaRegisterClass(L, 'LStatelessWidget', '', 0);
  ...
  luaRegisterClass(L, 'LStatefulWidget', '', 0);
  ...
  luaRegisterClass(L, 'StatefulBuilder', '', 0);
  ...
  luaRegisterClass(L, 'Scrollbar', '', 0);
  ...
  luaRegisterClass(L, 'ScrollController', '', 0);
  ...
  luaRegisterClass(L, 'SingleChildScrollView', '', 0);
  ...
  luaRegisterClass(L, 'Container', '', 0);
  ...
  luaRegisterClass(L, 'Decoration', '', 0);

  luaRegisterClass(L, 'BoxDecoration', 'Decoration', 0);
  ...
  luaRegisterClass(L, 'ShapeDecoration', 'Decoration', 0);
  ...
  luaRegisterClass(L, 'DecoratedBox', '', 0);
  ...
  address = ffi.Pointer.fromFunction<lua_CFunction>(_BorderSide_getProp_, exceptionalReturn).address;
  luaRegisterClass(L, 'BorderSide', '', address);
  ...
  address = ffi.Pointer.fromFunction<lua_CFunction>(_Radius_getProp_, exceptionalReturn).address;
  luaRegisterClass(L, 'Radius', '', address);
  ...
  luaRegisterClass(L, 'BorderRadiusGeometry', '', 0);

  luaRegisterClass(L, 'BorderRadius', 'BorderRadiusGeometry', 0);
  ...
  luaRegisterClass(L, 'OutlineInputBorder', '', 0);
  ...
  luaRegisterClass(L, 'EdgeInsetsGeometry', '', 0);

  address = ffi.Pointer.fromFunction<lua_CFunction>(_EdgeInsets_getProp_, exceptionalReturn).address;
  luaRegisterClass(L, 'EdgeInsets', 'EdgeInsetsGeometry', address);
  ...
  address = ffi.Pointer.fromFunction<lua_CFunction>(_Size_getProp_, exceptionalReturn).address;
  luaRegisterClass(L, 'Size', '', address);
  ...
  luaRegisterClass(L, 'BoxConstraints', '', 0);
  ...
  luaRegisterClass(L, 'ConstrainedBox', '', 0);
  ...
  luaRegisterClass(L, 'LimitedBox', '', 0);
  ...
  luaRegisterClass(L, 'CheckboxListTile', '', 0);
  ...
  luaRegisterClass(L, 'TextInputFormatter', '', 0);

  luaRegisterClass(L, 'LTextInputFormatter', 'TextInputFormatter', 0);
  ...
  luaRegisterClass(L, 'TableColumnWidth', '', 0);

  luaRegisterClass(L, 'FlexColumnWidth', 'TableColumnWidth', 0);
  ...
  address = ffi.Pointer.fromFunction<lua_CFunction>(_MediaQueryData_getProp_, exceptionalReturn).address;
  luaRegisterClass(L, 'MediaQueryData', '', address);
  ...
  luaRegisterClass(L, 'MediaQuery', '', 0);
  ...
  address = ffi.Pointer.fromFunction<lua_CFunction>(_Offset_getProp_, exceptionalReturn).address;
  luaRegisterClass(L, 'Offset', '', address);
  ...
  luaRegisterClass(L, 'AlignmentGeometry', '', 0);

  address = ffi.Pointer.fromFunction<lua_CFunction>(_Alignment_getProp_, exceptionalReturn).address;
  luaRegisterClass(L, 'Alignment', 'AlignmentGeometry', address);
  ...
  luaRegisterClass(L, 'DefaultTextStyle', '', 0);
  ...
  luaRegisterClass(L, 'SliderTheme', '', 0);
  ...
  luaRegisterClass(L, 'SliderThemeData', '', 0);
  ...
  address = ffi.Pointer.fromFunction<lua_CFunction>(_SliderComponentShape_getProp_, exceptionalReturn).address;
  luaRegisterClass(L, 'SliderComponentShape', '', address);

  luaRegisterClass(L, 'Slider', '', 0);
  ...
  luaRegisterClass(L, 'Positioned', '', 0);
  ...
  luaRegisterClass(L, 'LongPressDraggable', '', 0);
  ...
  luaRegisterClass(L, 'Draggable', '', 0);
  ...
  luaRegisterClass(L, 'DragTarget', '', 0);
  ...
  address = ffi.Pointer.fromFunction<lua_CFunction>(_DraggableDetails_getProp_, exceptionalReturn).address;
  luaRegisterClass(L, 'DraggableDetails', '', address);

  luaRegisterClass(L, 'Opacity', '', 0);
  ...
  luaRegisterClass(L, 'ColoredBox', '', 0);
  ...
  address = ffi.Pointer.fromFunction<lua_CFunction>(_Velocity_getProp_, exceptionalReturn).address;
  luaRegisterClass(L, 'Velocity', '', address);

  luaRegisterClass(L, 'Divider', '', 0);
  ...
  luaRegisterClass(L, 'VerticalDivider', '', 0);
  ...
  luaRegisterClass(L, 'GestureDetector', '', 0);
  ...
  luaRegisterClass(L, 'DragDownDetails', '', 0);

  luaRegisterClass(L, 'DragEndDetails', '', 0);

  address = ffi.Pointer.fromFunction<lua_CFunction>(_DragStartDetails_getProp_, exceptionalReturn).address;
  luaRegisterClass(L, 'DragStartDetails', '', address);

  address = ffi.Pointer.fromFunction<lua_CFunction>(_DragUpdateDetails_getProp_, exceptionalReturn).address;
  luaRegisterClass(L, 'DragUpdateDetails', '', address);

  luaRegisterClass(L, 'LongPressDownDetails', '', 0);

  luaRegisterClass(L, 'LongPressEndDetails', '', 0);

  luaRegisterClass(L, 'LongPressMoveUpdateDetails', '', 0);

  luaRegisterClass(L, 'LongPressStartDetails', '', 0);

  luaRegisterClass(L, 'TapDownDetails', '', 0);

  luaRegisterClass(L, 'TapUpDetails', '', 0);

  luaRegisterClass(L, 'Key', '', 0);

  luaRegisterClass(L, 'UniqueKey', 'Key', 0);
  ...
  address = ffi.Pointer.fromFunction<lua_CFunction>(_Duration_getProp_, exceptionalReturn).address;
  luaRegisterClass(L, 'Duration', '', address);
  ...
  luaRegisterClass(L, 'AlertDialog', '', 0);
  ...
  luaRegisterClass(L, 'SimpleDialog', '', 0);
  ...
  luaRegisterClass(L, 'CupertinoAlertDialog', '', 0);
  ...
  luaRegisterClass(L, 'Future<dynamic>', 'Future', 0);

  luaRegisterClass(L, 'FloatingActionButton', '', 0);
  ...
  luaRegisterClass(L, 'BottomNavigationBar', '', 0);
  ...
  luaRegisterClass(L, 'BottomNavigationBarItem', '', 0);
  ...
  luaRegisterClass(L, 'ScaffoldMessenger', '', 0);
  ...
  luaRegisterClass(L, 'ScaffoldMessengerState', '', 0);
  ...
  luaRegisterClass(L, 'MaterialBanner', '', 0);
  ...
  luaRegisterClass(L, 'PopupMenuButton', '', 0);
  ...
  luaRegisterClass(L, 'PopupMenuEntry', '', 0);

  luaRegisterClass(L, 'PopupMenuDivider', 'PopupMenuEntry', 0);
  ...
  luaRegisterClass(L, 'PopupMenuItem', 'PopupMenuEntry', 0);
  ...
  luaRegisterClass(L, 'CheckedPopupMenuItem', 'PopupMenuItem', 0);
  ...
  luaRegisterClass(L, 'RoundedRectangleBorder', '', 0);
  ...
  luaRegisterClass(L, 'DropdownMenuItem', '', 0);
  ...
  luaRegisterClass(L, 'DropdownButton', '', 0);
  ...
  luaRegisterClass(L, 'ButtonSegment', '', 0);
  ...
  luaRegisterClass(L, 'SegmentedButton', '', 0);
  ...
  luaRegisterClass(L, 'OverlayState', '', 0);
  ...
  luaRegisterClass(L, 'OverlayEntry', '', 0);
  ...
  luaRegisterClass(L, 'RotatedBox', '', 0);
  ...
  luaRegisterClass(L, 'Transform', '', 0);
  ...
  luaRegisterClass(L, 'CircularProgressIndicator', '', 0);
  ...
  luaRegisterClass(L, 'LinearProgressIndicator', '', 0);
  ...
  luaRegisterClass(L, 'FittedBox', '', 0);
  ...
  address = ffi.Pointer.fromFunction<lua_CFunction>(_SchedulerBinding_getProp_, exceptionalReturn).address;
  luaRegisterClass(L, 'SchedulerBinding', '', address);
  ...
  luaRegisterClass(L, 'MaterialStatePropertyT', '', 0);
  ...
  luaRegisterClass(L, 'MaterialStateColor', 'Color', 0);
  ...
  luaRegisterClass(L, 'ButtonStyle', '', 0);
  ...
  luaRegisterClass(L, 'ToggleButtons', '', 0);
  ...
  luaRegisterClass(L, 'Directionality', '', 0);
  ...
  luaRegisterClass(L, 'IntrinsicHeight', '', 0);
  ...
  luaRegisterClass(L, 'IntrinsicWidth', '', 0);
  ...
  luaRegisterClass(L, 'SwitchListTile', '', 0);
  ...
  address = ffi.Pointer.fromFunction<lua_CFunction>(_VisualDensity_getProp_, exceptionalReturn).address;
  luaRegisterClass(L, 'VisualDensity', '', address);
